...
"""
Start up a Simple topology for EE323
"""
...
class EE323Topo( Topo ):
    "EE 323 Lab 3 Topology"
...
class EE323Controller( Controller ):
    "Controller for EE323 Multiple IP Bridge"
...
def starthttp( host ):
    ...
    host.cmd( 'cd ./http_%s/; nohup python2.6 ./webserver.py &' % (host.name) )
